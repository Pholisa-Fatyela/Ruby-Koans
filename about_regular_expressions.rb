...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_slash_a_anchors_to_the_start_of_the_string # finds the start of a string
    assert_equal "start", "start end"[/\Astart/]
    assert_equal nil, "start end"[/\Aend/]
  end

  def test_slash_z_anchors_to_the_end_of_the_string # finds the end of the string
